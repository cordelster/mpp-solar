...
log = logging.getLogger("pi30m045_v2")
...
class pi30m045_v2(pi30max_v2):
    def __str__(self):
        return "PI30_v2 protocol handler for LV6548 and similar inverters"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"PI30M045_v2"
        # Add pi30m045_v2 specific commands to pi30max_v2 commands
        self.COMMANDS.update(QUERY_COMMANDS)
        # Add pi30m045_v2 specific setter commands
