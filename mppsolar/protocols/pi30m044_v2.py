...
from .pi30max_v2 import pi30max_v2

log = logging.getLogger("pi30m044_v2")
...
class pi30m044_v2(pi30max_v2):
    def __str__(self):
        return "PI30_v2 protocol handler for Voltronic Axpert Max 7.2k (general_model_name 044, model_name MKS2-7200)"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"PI30M044_v2"
        # Add pi30m044_v2 specific commands to pi30max_v2 commands
        self.COMMANDS.update(QUERY_COMMANDS)
        # Add pi30m044_v2 specific setter commands
