...
class pi18_v2(AbstractProtocol):
    def __str__(self):
        return "PI18_v2 protocol handler"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"PI18_v2"
        self.NOCRC = False
    ...
    def get_responses(self, response):
        """
        Override the default get_responses as its different for PI18_v2
        """
        if not response:
            return ["No response"]
