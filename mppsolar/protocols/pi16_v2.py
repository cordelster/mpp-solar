...
class pi16_v2(AbstractProtocol):
    def __str__(self):
        return "PI16_v2 protocol handler"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"PI16_v2"
    ...
    def get_full_command(self, command) -> bytes:
        """
        Override the default get_full_command as its different for PI16_v2
        """
