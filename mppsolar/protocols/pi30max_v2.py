...
from .pi30_v2 import pi30_v2

log = logging.getLogger("pi30max_v2")
...
class pi30max_v2(pi30_v2):
    def __str__(self):
        return "PI30_v2 protocol handler for LV6048MAX and similar inverters"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"PI30MAX_v2"
        # Add pi30max_v2 specific commands to pi30_v2 commands
        self.COMMANDS.update(QUERY_COMMANDS)
        # Add pi30max_v2 specific setter commands
        self.COMMANDS.update(SETTER_COMMANDS)
        # remove any unwanted pi30_v2 commands
